...
public class Util {
   ...
   public static byte[] toBase64(byte[] buf, int start, int length, boolean include_pad) {
   ...
   public static String getFingerPrint(HASH hash, byte[] data, boolean include_prefix, boolean force_hex) {
      try {
         hash.init();
   ...
   public static Socket createSocket(String host, int port, int timeout) throws Exception {
   ...
   public static byte[] str2byte(String str, Charset encoding) {
      if (str == null)
         return null;
