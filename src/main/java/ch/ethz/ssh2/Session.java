...
public class Session {
   ...
   public void requestWindowChange(int term_width_characters, int term_height_characters, int term_width_pixels, int term_height_pixels) throws IOException {
      ...
      this.cm.requestWindowChange(this.cn, term_width_characters, term_height_characters, term_width_pixels, term_height_pixels);
   }
   ...
   public void execCommand(String cmd) throws IOException {
      this.execCommand(cmd, (String)null);
   }
   ...
   public void execCommand(String cmd, String charsetName) throws IOException {
      if (cmd == null) {
         ...
         this.cm.requestExecCommand(this.cn, cmd, charsetName);
      }
   }
